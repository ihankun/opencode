...
export const SETTINGS_SEARCH_DEFINITIONS: SettingsSearchDefinition[] = [
  ...
  ...definitions('agent', ['agent.behavior', 'agent.backgroundSubagents', 'agent.toolInteraction', 'chat.alwaysAllowMode', 'chat.approvePendingOnFullAuto', 'chat.queueFollowupMessages', 'chat.immersiveMode', 'chat.inlineToolRequests', 'chat.descriptiveToolSteps', 'chat.processCollapse', 'chat.compactInlinePermission']),
  ...definitions('chat', ['chat.pathsFormatting', 'chat.conversationExperience', 'chat.stepFinishInfo', 'chat.collapseLongMessages', 'chat.autoCollapseExecutionProcess', 'chat.collapseToolOutput', 'chat.renderUserMarkdown', 'chat.outlineCurrentHighlight', 'chat.enterKeyBehavior', 'chat.actionsOnLatestAssistantOnly', 'chat.desktopCollapsedInputDock', 'chat.thinkingDisplay']),
  ...definitions('workspace', ['workspace.layout', 'workspace.terminal', 'workspace.sidebar', 'appearance.wakeLock', 'appearance.codeWordWrap', 'workspace.manualTerminalTitles', 'workspace.terminalCopyOnSelect', 'workspace.terminalRightClickPaste', 'appearance.folderStyleRecents', 'appearance.showChildSessions']),
