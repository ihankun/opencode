...
export const SETTINGS_SEARCH_DEFINITIONS: SettingsSearchDefinition[] = [
  ...
  ...definitions('agent', ['agent.behavior', 'agent.backgroundSubagents', 'agent.toolInteraction', 'chat.alwaysAllowMode', 'chat.approvePendingOnFullAuto', 'chat.queueFollowupMessages', 'chat.inlineToolRequests', 'chat.descriptiveToolSteps', 'chat.processCollapse', 'chat.compactInlinePermission']),
  ...definitions('chat', ['chat.pathsFormatting', 'chat.conversationExperience', 'chat.stepFinishInfo', 'chat.collapseLongMessages', 'chat.outlineCurrentHighlight', 'chat.enterKeyBehavior', 'chat.actionsOnLatestAssistantOnly', 'chat.desktopCollapsedInputDock']),
