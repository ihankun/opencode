...
export const SETTINGS_SEARCH_DEFINITIONS: SettingsSearchDefinition[] = [
  ...
  ...definitions('chat', ['chat.pathsFormatting', 'chat.conversationExperience', 'chat.stepFinishInfo', 'chat.collapseLongMessages', 'chat.enterKeyBehavior', 'chat.actionsOnLatestAssistantOnly', 'chat.desktopCollapsedInputDock']),
