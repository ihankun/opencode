...
export const SETTINGS_SEARCH_DEFINITIONS: SettingsSearchDefinition[] = [
  ...
  ...definitions('agent', ['agent.behavior', 'agent.backgroundSubagents', 'agent.toolInteraction', 'chat.approvePendingOnFullAuto', 'chat.queueFollowupMessages', 'chat.inlineToolRequests', 'chat.descriptiveToolSteps', 'chat.processCollapse', 'chat.compactInlinePermission']),
