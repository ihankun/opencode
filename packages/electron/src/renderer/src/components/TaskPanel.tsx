    ...
    <div className="flex h-full flex-col bg-bg-100">
      <div className="window-drag-region flex h-14 shrink-0 items-center justify-between border-b border-border-200/50 px-6">
        ...
        <div className="flex gap-1.5">
          ...
          {view === 'tasks' && <button className="inline-flex h-8 items-center gap-1.5 rounded-lg bg-accent-main-100 px-3 text-[length:var(--fs-sm)] text-oncolor-100 transition-colors hover:bg-accent-main-200" onClick={() => { setDraftInput(undefined); setEditing('new') }}><PlusIcon size={13} />{t('taskPanel.newTask')}</button>}
        </div>
      </div>
