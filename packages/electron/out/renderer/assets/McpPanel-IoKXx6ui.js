      ...
      try {
        ...
        try {
          ...
          if ((await __vitePreload(async () => {
            const { isTauri } = await import("./main-CxRsPsI8.js").then((n) => n.bS);
            return { isTauri };
          }, true ? __vite__mapDeps([0,1]) : void 0, import.meta.url)).isTauri()) {
            __vitePreload(() => import("./index-CTzXdWo9.js"), true ? __vite__mapDeps([2,0,1]) : void 0, import.meta.url).then((mod) => mod.openUrl(result.url)).catch(() => window.open(result.url, "_blank", "noopener,noreferrer"));
          } else {
