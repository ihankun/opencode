const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./main-CbDQK4WE.js","./main-xvrYfrv0.css"])))=>i.map(i=>d[i]);
import { ai as __vitePreload, aX as getPtyConnectUrl, aJ as getAuthHeader } from "./main-CbDQK4WE.js";
async function connectTauriPty({
  ...
  const { invoke, Channel } = await __vitePreload(async () => {
    const { invoke: invoke2, Channel: Channel2 } = await import("./main-CbDQK4WE.js").then((n) => n.aq);
