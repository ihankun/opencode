const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-CkDHrpSK.js","./main-CbDQK4WE.js","./main-xvrYfrv0.css"])))=>i.map(i=>d[i]);
import { aL as getDefaultExportFromCjs, bi as isTauri, ai as __vitePreload } from "./main-CbDQK4WE.js";
var _2020 = { exports: {} };
var core$1 = {};
var validate = {};
var boolSchema = {};
...
const properties$9 = { "$data": { "type": "string", "anyOf": [{ "format": "relative-json-pointer" }, { "format": "json-pointer" }] } };
...
const properties$6 = { "prefixItems": { "$ref": "#/$defs/schemaArray" }, "items": { "$dynamicRef": "#meta" }, "contains": { "$dynamicRef": "#meta" }, "additionalProperties": { "$dynamicRef": "#meta" }, "properties": { "type": "object", "additionalProperties": { "$dynamicRef": "#meta" }, "default": {} }, "patternProperties": { "type": "object", "additionalProperties": { "$dynamicRef": "#meta" }, "propertyNames": { "format": "regex" }, "default": {} }, "dependentSchemas": { "type": "object", "additionalProperties": { "$dynamicRef": "#meta" }, "default": {} }, "propertyNames": { "$dynamicRef": "#meta" }, "if": { "$dynamicRef": "#meta" }, "then": { "$dynamicRef": "#meta" }, "else": { "$dynamicRef": "#meta" }, "allOf": { "$ref": "#/$defs/schemaArray" }, "anyOf": { "$ref": "#/$defs/schemaArray" }, "oneOf": { "$ref": "#/$defs/schemaArray" }, "not": { "$dynamicRef": "#meta" } };
...
const properties$5 = { "unevaluatedItems": { "$dynamicRef": "#meta" }, "unevaluatedProperties": { "$dynamicRef": "#meta" } };
const require$$2 = {
  $schema: $schema$5,
  $id: $id$5,
...
const properties$4 = { "contentEncoding": { "type": "string" }, "contentMediaType": { "type": "string" }, "contentSchema": { "$dynamicRef": "#meta" } };
const require$$3 = {
  $schema: $schema$4,
  $id: $id$4,
...
const properties$2 = { "format": { "type": "string" } };
const require$$5 = {
  $schema: $schema$2,
  $id: $id$2,
...
const properties$1 = { "title": { "type": "string" }, "description": { "type": "string" }, "default": true, "deprecated": { "type": "boolean", "default": false }, "readOnly": { "type": "boolean", "default": false }, "writeOnly": { "type": "boolean", "default": false }, "examples": { "type": "array", "items": true } };
const require$$6 = {
  $schema: $schema$1,
  $id: $id$1,
...
let schemaFetch;
let schemaFetchPromise;
async function validateAgainstOfficialConfigSchema(config) {
  try {
    const validate2 = await getOfficialConfigValidator();
    const valid = validate2(config);
    if (valid) return { errors: [] };
    return { errors: normalizeAjvErrors(validate2.errors ?? []) };
  } catch (error) {
...
async function getSchemaFetch() {
  if (!isTauri()) return globalThis.fetch;
  if (schemaFetch) return schemaFetch;
  schemaFetchPromise ??= __vitePreload(() => import("./index-CkDHrpSK.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url).then((mod) => {
    schemaFetch = mod.fetch;
    return schemaFetch;
  }).catch((error) => {
    schemaFetchPromise = void 0;
    throw error;
  });
  return schemaFetchPromise;
}
function normalizeAjvErrors(errors2) {
  const normalized = errors2.map((error) => ({ ...errorLocation(error), message: error.message ?? "invalid value" }));
...
function joinLocation(pointer, key) {
...
export {
  validateAgainstOfficialConfigSchema
};
