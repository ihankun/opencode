import { R as Rgb, aZ as rgbConvert, T as define, Y as extend, a as Color, aL as nogamma, ak as hue, a2 as getAccDescription, b2 as setAccDescription, a6 as getDiagramTitle, b5 as setDiagramTitle, a3 as getAccTitle, b3 as setAccTitle, b as __name, a5 as getConfig2, b0 as select, E as configureSvgSize, O as dayjs2, aE as log, z as common_default, V as distExports, t as clear, bn as utils_default } from "./mermaid.core-fCdjP7EW.js";
import { aL as getDefaultExportFromCjs } from "./main-CxRsPsI8.js";
import { b as bisector, t as tickStep, c as continuous, a as copy, l as linear } from "./linear-BBGpiMlU.js";
import { i as initRange } from "./init-ZxktEp_H.js";
import "./defaultLocale-Pq0tsfXx.js";
...
function requireDuration() {
  ...
  (function(module, exports) {
    !(function(t, s) {
      ...
      var t, s, n = 1e3, i = 6e4, e = 36e5, r = 864e5, o = 31536e6, u = 2628e6, d = /^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/, a = /\[([^\]]+)]|YYYY|YY|Y|M{1,2}|D{1,2}|H{1,2}|m{1,2}|s{1,2}|SSS/g, h = { years: o, months: u, days: r, hours: e, minutes: i, seconds: n, milliseconds: 1, weeks: 6048e5 }, c = function(t4) {
        ...
        return y2.calMilliseconds = function() {
          ...
          var t4 = this.$ms;
          this.$d.years = $(t4 / o), t4 %= o, this.$d.months = $(t4 / u), t4 %= u, this.$d.days = $(t4 / r), t4 %= r, this.$d.hours = $(t4 / e), t4 %= e, this.$d.minutes = $(t4 / i), t4 %= i, this.$d.seconds = $(t4 / n), t4 %= n, this.$d.milliseconds = t4;
