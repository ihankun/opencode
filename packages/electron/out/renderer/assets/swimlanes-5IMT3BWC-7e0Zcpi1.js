const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./sizeCapture-X5ZJPWSS-BM9H6ORH.js","./mermaid.core-fCdjP7EW.js","./main-CxRsPsI8.js","./main-DuqtzUZU.css"])))=>i.map(i=>d[i]);
import { ai as __vitePreload } from "./main-CxRsPsI8.js";
import { c as clear$2 } from "./chunk-RYQCIY6F-E1Zy9DJ7.js";
import { aH as markers_default, w as clear2, u as clear, v as clear$1, aE as log, a5 as getConfig2, ao as insertNode, al as insertCluster, aS as positionNode, am as insertEdge, an as insertEdgeLabel, a4 as getConfig, ad as getSubGraphTitleMargins, W as edgeLabels, bn as utils_default, bg as terminalLabels, b as __name, aG as markerOffsets } from "./mermaid.core-fCdjP7EW.js";
...
async function createGraphWithElements(element, data4Layout) {
  ...
  if (globalThis.mermaidCaptureSizes) {
    const { captureNodeSizes } = await __vitePreload(async () => {
      const { captureNodeSizes: captureNodeSizes2 } = await import("./sizeCapture-X5ZJPWSS-BM9H6ORH.js");
