import { g as getIconStyles } from "./chunk-5VM5RSS4-CPLad_83.js";
import { ax as isPrimitive, ae as getTag, ay as isTypedArray, bi as uint32ArrayTag, bh as uint16ArrayTag, bk as uint8ClampedArrayTag, bj as uint8ArrayTag, be as symbolTag, bc as stringTag, b7 as setTag, aV as regexpTag, aN as objectTag, aM as numberTag, aF as mapTag, aq as int32ArrayTag, ap as int16ArrayTag, ar as int8ArrayTag, a0 as float64ArrayTag, $ as float32ArrayTag, N as dateTag, n as booleanTag, M as dataViewTag, h as arrayBufferTag, i as arrayTag, f as argumentsTag, b as __name, a4 as getConfig, b0 as select, E as configureSvgSize, aE as log, t as clear, a_ as rgba, a5 as getConfig2, aa as getLineFunctionsWithOffset, aB as line, K as curveBasis, ag as getUrl, a8 as getEffectiveHtmlLabels, I as createText, B as computeLabelTransform, ad as getSubGraphTitleMargins, bn as utils_default, z as common_default, ac as getStylesFromArray, a$ as sanitizeText, P as decodeEntities, D as configureLabelImages } from "./mermaid.core-D9mdAS1t.js";
import { G as Graph } from "./graph-C3dqXi9B.js";
import { c as channel } from "./channel-_uK4fL14.js";
...
function clone(obj) {
  ...
  if (tag === "[object Boolean]" || tag === "[object Number]" || tag === "[object String]") {
    ...
    if (tag === "[object String]") cloneStringObjectProperties(clone2, obj);
    else copyOwnProperties(clone2, obj);
    return clone2;
  }
