const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./sizeCapture-X5ZJPWSS-CYiKWRZE.js","./mermaid.core-D9mdAS1t.js","./main-CbDQK4WE.js","./main-xvrYfrv0.css"])))=>i.map(i=>d[i]);
import { ai as __vitePreload } from "./main-CbDQK4WE.js";
import { c as clear$2 } from "./chunk-RYQCIY6F-BlRVlHVl.js";
import { aH as markers_default, w as clear2, u as clear, v as clear$1, aE as log, a5 as getConfig2, ao as insertNode, al as insertCluster, aS as positionNode, am as insertEdge, an as insertEdgeLabel, a4 as getConfig, ad as getSubGraphTitleMargins, W as edgeLabels, bn as utils_default, bg as terminalLabels, b as __name, aG as markerOffsets } from "./mermaid.core-D9mdAS1t.js";
import { G as Graph } from "./graph-C3dqXi9B.js";
import "./map-BG90Ssym.js";
async function createGraphWithElements(element, data4Layout) {
  ...
  if (globalThis.mermaidCaptureSizes) {
    const { captureNodeSizes } = await __vitePreload(async () => {
      const { captureNodeSizes: captureNodeSizes2 } = await import("./sizeCapture-X5ZJPWSS-CYiKWRZE.js");
      return { captureNodeSizes: captureNodeSizes2 };
...
function collapseRedundantRectangularDoglegs(edges, nodeByIdMap) {
  ...
  const candidateIsSafe = /* @__PURE__ */ __name((edge, candidate) => {
    ...
    for (const segment of candidateSegments) {
      ...
      if (segmentHitsAnyRect(segment.a, segment.b, labelRects, [], -2)) {
        return false;
      }
    }
    for (const other of edges) {
...
function nudgeSharedInteriorSubpaths(edges, nodeByIdMap) {
  ...
  const candidateIsSafe = /* @__PURE__ */ __name((edge, candidate) => {
    ...
    for (const segment of candidateSegments) {
      ...
      if (segmentHitsAnyRect(segment.a, segment.b, labelRects, ownLabelIds, -2)) {
        return false;
      }
    }
    for (const other of edges) {
...
function validateSwimlanesLayout(layout) {
  ...
  for (const edge of edges) {
    ...
    for (const rect of nodeRects) {
      ...
      for (let i = 0; i < points.length - 1; i++) {
        if (segmentBoundsOverlapRect(points[i], points[i + 1], rect, -1)) {
          issues.push({
