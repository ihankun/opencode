const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-B1XPbIMj.js","./main-CxRsPsI8.js","./main-DuqtzUZU.css"])))=>i.map(i=>d[i]);
import { aL as getDefaultExportFromCjs, bi as isTauri, ai as __vitePreload } from "./main-CxRsPsI8.js";
var _2020 = { exports: {} };
var core$1 = {};
var validate = {};
var boolSchema = {};
...
async function getSchemaFetch() {
  ...
  schemaFetchPromise ??= __vitePreload(() => import("./index-B1XPbIMj.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url).then((mod) => {
